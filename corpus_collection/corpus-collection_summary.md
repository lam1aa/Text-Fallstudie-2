...
**Textformate und Metadaten**

Darauf aufbauend haben wir die [Erscheinungsformen von Text im digitalen Raum](corpus-collection_text_as_digital_objects) untersucht und dabei gelernt, welche Textformate sich für welche Zwecke eignen. 
...
Abschließend haben wir unser eigenes Forschungskorpus — bestehend aus den Pressemitteilungen der Berliner Exekutive — [systematisch beschrieben](corpus-collection_building-our-corpus). Damit ist unser Forschungskorpus ist zum Scrapen bereit, sobald wir alle erforderlichen Tools, Formate und Techniken erlernt haben. 
```
